    ...
    return (
        <div className={css.body}>
            ...
            <div itemScope itemType="http://schema.org/Person">
                <Link itemProp="url" href="https://github.com/net-js ">
                <div itemProp="name"><h1>Net-js</h1></div>
                </Link>
            </div>
            <div itemScope itemType="http://schema.org/Organization">
                <Link itemProp="url" href="https://github.com/net-js/blogy">
            ...
            <div itemProp="description">
                ...
                <p>I net-js a self taught beginner doing both backend (mostly) and frontend. I use <Link href="https://github.com/nodejs/node">Node.js</Link></p>
                <p>
                    I’m looking to collaborate on <strong>Node.js, Typescript, Front-end apps, Electron, JavaScript librarys</strong> etc;
                    <br />
                    <br />
                    On StackOverflow: <Link href="https://stackoverflow.com/users/18844713/steve?tab=profile"><strong>Steve</strong></Link>;
                    <br />
                    On NPMjs: <Link href="https://www.npmjs.com/~net-js">net-js</Link>
                    <br />
                    On Github: <Link href="https://github.com/net-js">net-js</Link></p>
                <p>| sign --&gt; <Link href="/sign.txt"><a>sign.txt</a></Link> <em>(<Link href="https://gist.github.com/net-js/732043a7abf3bc2458425a63edd4df78">PublicKey</Link> format is hex and rsa-sha265)</em> |</p>
            </div>
        </div>
    )
}